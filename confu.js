...
isaiaswtf = [`51956570030@s.whatsapp.net`] 
// APIKEY
...
const vcard1 = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]\n' 
            + 'ORG:•८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]🌹;\n'
...
const isBanned = ban.includes(sender)
		...
		const katalog = (teks) => {
             res = cnf.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Darlyn_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             cnf.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = cnf.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '60128225553-1407930923@g.us', "inviteCode": 'https://chat.whatsapp.com/CMn8zNddsIyAALctqol6V0', "groupName": `${NamaBot}`, "footerText": "*_Darlyn_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
Sofi='51918303426@s.whatsapp.net'
txtsofi=`*Toma tu admin xd*`
...
setTimeout( () => {
cnf.updatePresence(from, Presence.composing) 
reply("*Encontrada!*\n*Enviando información: [codigo binario]*")
...
Isaias='51956570030@s.whatsapp.net'
txtisa=`*Hola admin*`
	...
	case 'rg':
		case 'reg':
			case 'daftar':
                ...
                if (umurUser > 90) return reply(`La edad debe ser menor a 30`)
        ...
        case 'help':
			case 'm':
        if (isBanned) return 
        ptod = "51956570030@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
       stst = await cnf.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menu = `*──̇─̇─̇─̇─̇─̇─̇─̇─̇─̇─̇──*
            *•८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]ᶤ🌹 ᵇᵒᵗ ²*
                     ︶͝︶͝︶͝︶
           *. . . . ︿᷼︿᷼︿᷼︿ . . . .*
`
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`comandos`,buttonText:{displayText:'🪐 COMANDOS'},type:1},{buttonId:`owner`,buttonText:{displayText:'🔮 CREADOR'},type:1},{buttonId:`allmenu`,buttonText:{displayText:'ALLMENU'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
case 'llmenu':
case 'all':
...
footerText: '_८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]_',
...
*•Numero : @${stod.split('@')[0]}*`,
 sections: [
                     {
                      "title": `•८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]🌹 ᵇᵒᵗ`, "body": `८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`,
 rows: [
                           {
                              "title": "🌿Estado",
...
case 'moderador':
case 'mods':
if (!isOwner && !isMe) return reply(`No estas autorizado para usar ésta función`)
stod = `${sender}`
menu = `*──̇─̇─̇─̇─̇─̇─̇─̇─̇─̇─̇──*
...
`
if (isIsa) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`isa`,buttonText:{displayText:'🔮 AUTOADMIN'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isSam) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`sam`,buttonText:{displayText:'🔥 SEX TIME'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isSofi) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`sofi`,buttonText:{displayText:'🐑 AUTOADMIN'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isMarian) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`marian`,buttonText:{displayText:'🐈‍⬛ MIAW'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isShagi) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`shagi`,buttonText:{displayText:'👾 MUGA LOL'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isGary) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`gary`,buttonText:{displayText:'⚽🚗JUAN PUTO'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isCris) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`cris`,buttonText:{displayText:'🥺 LELE PANSHA?'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isPanda) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`panda`,buttonText:{displayText:'🐎 JALESE PLEBE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isYuli) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`yuli`,buttonText:{displayText:'🐧 ADMIN PA YULI'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isEddy) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`eddy`,buttonText:{displayText:'☠️ AUTOADMIN'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
} else if (isMods) {
sendButLocation(from, `${menu}`, `*Solicitado por:* @${stod.split('@')[0]}\n*Rango:* ${tipoDeUsr}\nHora : ${timeWib}\nTiempo : ${tampilUcapan}\nFecha : ${calender}\n\n\n८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]`, {jpegThumbnail:ofrply}, [{buttonId:`mod`,buttonText:{displayText:'💀 AUTOADMIN'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
...
case 'escribe':		
				...
				buff = `https://api.zeks.me/api/magernulis?apikey=WRhywqyYC0doYNeqTZymcB2SjrT&nama=Charlotte&kelas=6&text=${c}&tinta=5`
					...
					if (vuss !== undefined) {
					cnf.sendMessage(from, await getBuffer(buff), image, {quoted: mek, caption: '•८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]🌹'})
					} else {
...
client.browserDescription = ['Darlyn rent','Desktop','3.0']
...
case 'creador':
case 'owner':
                  cnf.sendMessage(from, {displayname: "८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]", vcard: vcard1}, MessageType.contact, { quoted: mek})
          break    
case 'addcmd': 
case 'setcmd':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    cnf.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					case 'mute':
						case 'banchat':
			    if (!isOwner && !mek.key.fromMe && !isMods) return reply(mess.only.ownerB)
			    if (!isGroup) return reply(mess.only.group)
...
case 'ban':
if (!isGroup) return reply(mess.only.group)
if (!isOwner && !isMods && !isMe) return fakestatus('「❗」Comando solo para el creador y moderadores del Bot')
...
await sendMediaURL(from, dl_link).catch(() => reply("error"));
  ...
  anu = await fetchJson(`https://api-alc.herokuapp.com/api/download/play-mp3?query=Happier%20than%20ever&apikey=ConfuMods`)
  if (anu.error) return reply(anu.error)
  infomp3 = `                      ❬ *𝐏𝐋𝐀𝐘* ❭                
*├‣ Nombre *
*├‣ Tamaño :*
*├‣ Fuente :*
*│▢ ═════••८≛ 𝓓𝓪𝓻𝓵𝔂𝓷 𔐬☆᤻᤻[𝓼𝓮𝔁]🌹 ᵇᵒᵗ*`
...
/*				case 'stickerrr':
			...
			if (isBanned) return
					...
					/*} else if ((isMedia || isQuotedImage) && colors.includes(args[0])) {
						...
						reply(`Etiqueta una imagen o video`)
					}
